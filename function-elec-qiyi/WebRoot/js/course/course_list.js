$(function(){
	...
	$("#form_submit_exl").click(function(){
		var trimVal = $("#trimVal").val();
			trimVal = $.trim(trimVal);
			$("#trimVal").val(trimVal);
		var gradeIds = $('#cc').combo('getValue');
