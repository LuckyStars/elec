        	...
        	<table id="table5" width="740" bgcolor="#CCCCCC" border="0" cellspacing="1" cellpadding="0">
              ...
              <tr bgcolor="#FFFFFF">
                ...
                <td>
                	...
                	<a href="../bookSite/updateLevelStatusActivityLevel.action?activityLevel_id=<s:property value='activityLevel_id'/>&activityLevelStatus_id=<s:property value='siteStatus.siteStatus_checkId'/>" class="a_1">启用</a>
                	</s:if>
                	<s:elseif test='siteStatus.siteStatus_checkId == 1'>
                	<a href="../bookSite/updateLevelStatusActivityLevel.action?activityLevel_id=<s:property value='activityLevel_id'/>&activityLevelStatus_id=<s:property value='siteStatus.siteStatus_checkId'/>" class="a_1">禁用</a>
                	</s:elseif>
                	...
                	<a href="../bookSite/updateLevelStatusActivityLevel.action?activityLevel_id=<s:property value='activityLevel_id'/>&activityLevelStatus_id=3" class="a_1"  onclick="javascript: return confirm('是否确认撤销？撤销后此级别将不再显示！');">撤销</a>
                	</s:if>
                </td>
              </tr>
             </s:iterator>
