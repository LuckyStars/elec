...
<script type='text/javascript'>
	...
	function formatDateStr(date){
		...
		result += "-"+date.getDate();
		//var mydate = new Date();
		result += " "+"00";//mydate.getHours(); //获取当前小时数(0-23)
		result += ":"+"00";//mydate.getMinutes(); //获取当前分钟数(0-59)
		return result;
	}
	...
	function submitSiteForm(){
        if($.trim($("#beginDate").val())=="" || $.trim($("#endDate").val())==""){
			...
			if (check == "true") {
	        	...
	        	if($.trim($("#explain").val()).length>200){
	        		$("#explainnote").html("<font style='color:red;'>说明长度不能超过200</font>");
		        	return false;
		        }
		        $("#addevent").submit();
	    	}
      ...
      <div class="dg_par">
     	<table id="table1" width="440" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td>
            	<textarea id="explain" cols="36" rows="5" name="bookSite.bookSite_explain"></textarea><br></br><span id="explainnote">必填</span>
			</td>
          </tr>
        </table>
