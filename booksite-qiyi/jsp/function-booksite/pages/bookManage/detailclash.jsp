...
<link href="../function/function-booksite/styles/basic.css" rel="stylesheet" type="text/css" />
<script src="../common/agent.js" type="text/javascript"></script>
</head>
...
<div class="box">
	<div class="box_head">
    	<div class="left">
        <b><a href="../bookSite/retrieveOpenSite.action">场馆预订</a></b>
