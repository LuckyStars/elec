...
<div class="box">
    ...
    <div class="box_main">
        ...
        <form action="${prc}/bookSite/searchUser.action" method="post" name="surForm" id="surForm">
        	<div class="search">
        		姓名： <input type="text" name="userName" id="userName" maxlength="20">
               		 ...
               		 <td>
               		 	<c:forTokens items="${ur.roleArray}" delims="," var="roleId">
               		 		<c:choose>
               		 			...
               		 			<c:when test="${roleId eq 2}">申请人</c:when>
               		 			<c:when test="${roleId eq 3}">主管领导</c:when>
               		 			<c:when test="${roleId eq 4}">场馆负责人</c:when>
               		 		</c:choose>
               		 	</c:forTokens>
               		 </td>
              		 <td>
      ...
      <div class="dg_par">
     	<table id="table2" width="440" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td height="30">
            	<input name="userId" class="easyui-combotree" style="border: 1px solid #ccc;height:18px;" width="150px;"/>
            </td>
            <td height="30">&nbsp;</td>
            <td height="30">&nbsp;</td>
            <td height="30">&nbsp;</td>
          ...
          <tr>
            ...
            <td height="30">
             ...
             <td height="30">
            	<input type="checkbox" name="roleid" value="2"> 申请人
            </td>
             <td height="30">
            	<input type="checkbox" name="roleid" value="3" id="type" onclick="javascript:checktype();"> 主管领导
            </td>
          </tr>
          <tr style="display:none" id="typerow">
