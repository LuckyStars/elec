        ...
        <c:forEach var="course"  items="${ecSignCourseVos}" >
	        <tr>
				...
				--%>
			     <td>
			     	 <p>
		            <fmt:formatDate value="${course.ecCourseVO.signStartDate}" pattern="yyyy-MM-dd" />
		            </p>
	            	<p>
	            	<fmt:formatDate value="${course.ecCourseVO.signEndDate}" pattern="yyyy-MM-dd" />
	            	</p>
			     </td>
